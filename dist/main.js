...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _load_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./load-html */ \"./src/load-html.js\");\n/* harmony import */ var _factories_create_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factories/create-player */ \"./src/factories/create-player.js\");\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {\n  // Initiate HTMl and create players with ship layout\n  (0,_load_html__WEBPACK_IMPORTED_MODULE_0__.loadHTML)();\n  const player = (0,_factories_create_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(true);\n  const computer = (0,_factories_create_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(false);\n  player.opponent = computer;\n  computer.opponent = player;\n\n  player.gameboard.placeShip(4, 6, 2, true);\n  computer.gameboard.placeShip(4, 6, 2, true);\n\n  player.gameboard.placeShip(0, 0, 3, false);\n  computer.gameboard.placeShip(0, 0, 3, false);\n\n  player.gameboard.placeShip(6, 1, 5, true);\n  computer.gameboard.placeShip(6, 1, 5, true);\n\n  player.gameboard.placeShip(6, 8, 4, false);\n  computer.gameboard.placeShip(6, 8, 4, false);\n\n  (0,_load_html__WEBPACK_IMPORTED_MODULE_0__.loadGameboard)(player, document.getElementById(\"player-board\"));\n  (0,_load_html__WEBPACK_IMPORTED_MODULE_0__.loadGameboard)(computer, document.getElementById(\"computer-board\"));\n});\n\n\n//# sourceURL=webpack://battleship/./src/start-game.js?");
